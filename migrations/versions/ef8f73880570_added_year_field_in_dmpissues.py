"""Added year field in DmpIssues

Revision ID: ef8f73880570
Revises: 8d1e6a7e959a
Create Date: 2025-06-30 12:15:29.383998
...
revision: str = "ef8f73880570"
down_revision: Union[str, None] = "8d1e6a7e959a"
...
def upgrade() -> None:
    ...
    op.alter_column(
        "app_comments", "issue_id", existing_type=sa.BIGINT(), nullable=True
    )
    op.alter_column(
        "badges",
        "id",
    ...
    op.alter_column(
        "ccbp_tickets", "issue_id", existing_type=sa.BIGINT(), nullable=True
    )
    op.alter_column(
        "ccbp_tickets",
        "index",
    ...
    op.alter_column("chapters", "org_name", existing_type=sa.TEXT(), nullable=True)
    op.alter_column(
        "chapters",
        "discord_role_id",
    ...
    op.alter_column("community_orgs", "name", existing_type=sa.TEXT(), nullable=True)
    op.alter_column(
        "connected_prs",
        "created_at",
        existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    op.add_column(
        "contributor_points",
        sa.Column("contributors_id", sa.BigInteger(), nullable=True),
    )
    op.drop_constraint(
        "contributor_points_contributors_id_fkey",
        "contributor_points",
        type_="foreignkey",
    )
    ...
    op.add_column(
        "discord_engagement", sa.Column("converserbadge", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "discord_engagement", sa.Column("apprenticebadge", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "discord_engagement", sa.Column("rockstarbadge", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "discord_engagement", sa.Column("enthusiastbadge", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "discord_engagement", sa.Column("risingstarbadge", sa.Boolean(), nullable=True)
    )
    op.alter_column(
        "discord_engagement",
        "id",
    ...
    op.drop_constraint(
        "dmp_issue_updates_comment_id_key", "dmp_issue_updates", type_="unique"
    )
    op.drop_constraint(
        "dmp_issue_updates_dmp_id_fkey", "dmp_issue_updates", type_="foreignkey"
    )
    ...
    op.alter_column("dmp_issues", "repo_owner", existing_type=sa.TEXT(), nullable=False)
    op.alter_column(
        "dmp_issues",
        "year",
        existing_type=sa.BIGINT(),
        type_=sa.Integer(),
        nullable=True,
        comment="The year the issue was created",
    ...
    op.drop_constraint(
        "dmp_pr_updates_dmp_id_fkey", "dmp_pr_updates", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "dmp_week_updates_dmp_id_fkey", "dmp_week_updates", type_="foreignkey"
    )
    op.alter_column(
    ...
    op.drop_constraint(
        "github_installations_organisation_fkey",
        "github_installations",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "github_installations", "community_orgs", ["organisation"], ["name"]
    )
    op.alter_column(
        "github_organisations_to_organisations",
        "id",
        existing_type=sa.BIGINT(),
        server_default=None,
        existing_nullable=False,
    ...
    op.drop_constraint(
        "unique_issue_id_contributors", "issue_contributors", type_="unique"
    )
    op.drop_constraint(
        "issue_contributors_contributor_id_fkey",
        "issue_contributors",
        type_="foreignkey",
    )
    ...
    op.drop_constraint(
        "mentorship_program_site_structure_product_fkey",
        "mentorship_program_site_structure",
        type_="foreignkey",
    )
    op.drop_constraint(
        "mentorship_program_site_structure_contributor_fkey",
        "mentorship_program_site_structure",
        type_="foreignkey",
    )
    op.drop_constraint(
        "mentorship_program_site_structure_project_fkey",
        "mentorship_program_site_structure",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "mentorship_program_site_structure", "product", ["product_id"], ["id"]
    )
    op.drop_table_comment(
        "mentorship_program_site_structure",
    ...
    op.alter_column(
        "mentorship_program_website_commits",
        "date",
        existing_type=postgresql.TIMESTAMP(timezone=True),
        type_=db.models.DateTime(),
        existing_nullable=True,
    ...
    op.add_column(
        "mentorship_program_website_has_updated",
        sa.Column("project_id", sa.BigInteger(), nullable=True),
    )
    op.alter_column(
        "mentorship_program_website_has_updated",
    ...
    op.drop_constraint(
        "mentorship_program_website_has_updated_project_fkey",
        "mentorship_program_website_has_updated",
        type_="foreignkey",
    )
    ...
    op.drop_constraint(
        "point_transactions_user_id_fkey", "point_transactions", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "point_transactions", "contributors_registration", ["user_id"], ["id"]
    )
    op.create_foreign_key(
        None, "point_transactions", "mentor_details", ["angel_mentor_id"], ["id"]
    )
    op.alter_column(
        "points_mapping",
        "id",
    ...
    op.alter_column(
        "points_mapping", "points", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "points_mapping",
        "created_at",
    ...
    op.drop_table_comment(
        "pr_history", existing_comment="Holds records of pr webhooks", schema=None
    )
    ...
    op.create_foreign_key(
        None, "product", "discord_channels", ["channel_id"], ["channel_id"]
    )
    op.drop_table_comment(
        "product",
    ...
    op.add_column(
        "user_activity", sa.Column("contributor_id", sa.BigInteger(), nullable=False)
    )
    op.alter_column(
        "user_activity",
        "id",
    ...
    op.drop_constraint(
        "user_activity_mentor_id_fkey", "user_activity", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "user_activity", "contributors_registration", ["contributor_id"], ["id"]
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "user_activity_user_id_fkey", "user_activity", "users", ["user_id"], ["id"]
    )
    op.alter_column(
        "user_activity",
        "mentor_id",
    ...
    op.add_column(
        "product", sa.Column("channel", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.create_table_comment(
        "product",
    ...
    op.add_column(
        ...
        sa.Column(
            "points",
            sa.SMALLINT(),
            server_default=sa.text("'10'::smallint"),
            autoincrement=False,
            nullable=False,
        ),
    )
    op.create_table_comment(
        "pr_history", "Holds records of pr webhooks", existing_comment=None, schema=None
    )
    op.alter_column(
        "pr_history",
        "pr_id",
    ...
    op.alter_column(
        "points_mapping", "points", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "points_mapping",
        "complexity",
    ...
    op.drop_constraint(None, "point_transactions", type_="foreignkey")
    op.create_foreign_key(
        "point_transactions_user_id_fkey",
        "point_transactions",
        "contributors_registration",
        ["user_id"],
        ["id"],
    ...
    op.add_column(
        "mentorship_program_site_structure",
        sa.Column(
            "website directory_label", sa.TEXT(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "mentorship_program_site_structure",
    ...
    op.create_foreign_key(
        "mentorship_program_site_structure_contributor_fkey",
        "mentorship_program_site_structure",
        "__mentorship_program_selected_contributors",
        ["contributor"],
        ["name"],
    )
    op.create_foreign_key(
    ...
    op.create_unique_constraint(
        "unique_issue_id_mentors", "issue_mentors", ["issue_id"]
    )
    op.alter_column(
        "issue_mentors",
        "angel_mentor_id",
    ...
    op.create_unique_constraint(
        "unique_issue_id_contributors", "issue_contributors", ["issue_id"]
    )
    op.alter_column(
        "issue_contributors",
        "updated_at",
    ...
    op.alter_column(
        ...
        nullable=False,
        comment=None,
        existing_comment="The year the issue was created",
        existing_server_default=sa.text("2024"),
    )
    op.alter_column("dmp_issues", "repo_owner", existing_type=sa.TEXT(), nullable=True)
    op.alter_column(
        "dmp_issues",
        "id",
        existing_type=sa.BIGINT(),
    ...
    op.create_unique_constraint(
        "dmp_issue_updates_comment_id_key", "dmp_issue_updates", ["comment_id"]
    )
    op.alter_column(
        "dmp_issue_updates",
        "comment_updated_at",
    ...
    op.alter_column("community_orgs", "name", existing_type=sa.TEXT(), nullable=False)
    op.alter_column(
        "chapters",
        "created_at",
        existing_type=db.models.DateTime(),
    ...
    op.alter_column("chapters", "org_name", existing_type=sa.TEXT(), nullable=False)
    op.alter_column(
        "ccbp_tickets",
        "closed_at",
        existing_type=db.models.DateTime(),
    ...
    op.alter_column(
        "ccbp_tickets", "issue_id", existing_type=sa.BIGINT(), nullable=False
    )
    op.alter_column(
        "ccbp_tickets",
        "created_at",
    ...
    op.alter_column(
        "app_comments", "issue_id", existing_type=sa.BIGINT(), nullable=False
    )
    op.alter_column(
        "app_comments",
        "updated_at",
    ...
    op.create_table(
        "__mentorship_program_pull_request",
        ...
        sa.Column(
            "merged_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "assignees", postgresql.ARRAY(sa.TEXT()), autoincrement=False, nullable=True
        ),
        sa.Column(
            "requested_reviewers",
        ...
        sa.Column(
            "repository_owner_name", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "repository_owner_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "number_of_commits", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "number_of_comments", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "lines_of_code_added", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "lines_of_code_removed", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "number_of_files_changed", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product"],
            ["product.name"],
            name="__mentorship_program_projects_product_fkey",
    ...
    op.create_table(
        "__mentorship_program_tickets",
        sa.Column("url", sa.VARCHAR(length=255), autoincrement=False, nullable=True),
        sa.Column(
            "repository_url", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "comments_url", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "events_url", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "html_url", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("id", sa.BIGINT(), autoincrement=False, nullable=False),
        sa.Column(
            "node_id", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        "__mentorship_program_ticket_comments",
        sa.Column("id", sa.BIGINT(), autoincrement=False, nullable=False),
    ...
    op.create_table(
        "__community_program_unique_user_data",
        sa.Column(
            "id",
            sa.BIGINT(),
            sa.Identity(
        ...
        sa.Column(
            "linked_pr_author_id", sa.BIGINT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "linked_pr_author_username", sa.TEXT(), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            autoincrement=False,
            nullable=True,
            comment="the chapter they're associated with",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["organisation"],
            ["__community_organisations.name"],
            name="__mentors_organisation_fkey",
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "discord_id", name="contributors_registration_duplicate_discord_id_key"
        ),
        sa.UniqueConstraint(
            "github_id", name="contributors_registration_duplicate_github_id_key"
        ),
    )
    op.create_table(
        "__contributors_vc",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "uuid", name="unstructured discord data_duplicate_pkey"
        ),
        sa.UniqueConstraint(
            "uuid", name="unstructured discord data_duplicate_uuid_key"
        ),
    )
    op.create_table(
        "__comments",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "id", name="mentorship_program_selected_contributors_pkey"
        ),
        sa.UniqueConstraint(
            "name", name="mentorship_program_selected_contributors_name_key"
        ),
        comment="List of contributors selected for C4GT Mentorship Program 2023",
    )
    op.create_table(
        "__community_program_product_wise_tickets",
        sa.Column("url", sa.VARCHAR(length=255), autoincrement=False, nullable=True),
        sa.Column(
            "repository_url", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
